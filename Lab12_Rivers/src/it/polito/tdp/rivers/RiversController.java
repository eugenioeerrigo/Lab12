...
public class RiversController {
    ...
    void handleInfo(ActionEvent event) {
    	txtStartDate.setText(model.getDateFirstMisuration(boxRiver.getValue()).toString());
    	txtEndDate.setText(model.getDateLastMisuration(boxRiver.getValue()).toString());
    	txtNumMeasurements.setText(String.valueOf(model.getNumMisurations(boxRiver.getValue())));
    	txtFMed.setText(String.valueOf(model.getAvgMisurations(boxRiver.getValue())));
    }
    ...
    void handleSimula(ActionEvent event) {
    	try {
    	txtResult.clear();
    	txtResult.appendText("Risultati della simulazione\n\n");
    	txtResult.appendText(model.simula(Double.parseDouble(txtK.getText()), boxRiver.getValue()).toString());
